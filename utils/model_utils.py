...
def save_llm_checkpoint(is_peft_model,epoch, checkpoint_dir, avg_epoch_loss,
...
def save_torch_model(states,model_save_path):
    torch.save(states, model_save_path)
    print("__________________________________________________________________")
    print("Model checkpoint saved @ ",model_save_path)
